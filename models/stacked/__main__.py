...
from models.stacked.args import get_args
from models.stacked.model import StackedBert
...
if __name__ == '__main__':
    ...
    model = StackedBert(args) #HierarchicalBert(args)
    ...
    if not args.trained_model:
        ...
        model = model = StackedBert(args.model) #HierarchicalBert(args.model)
