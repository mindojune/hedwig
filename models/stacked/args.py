...
def get_args():
    ...
    #FT
    parser.add_argument('--ntoken', default=8, type=int,
                        help='# of output token = numlabel')

    parser.add_argument('--ninp', default=768, type=int,
                        help='sentence encoder output dim')
    parser.add_argument('--nhead', default=2, type=int,
                        help='# of attention heads')
    parser.add_argument('--nhid', default=200, type=int,
                        help='feedforward dim in transformer block')
    parser.add_argument('--nlayers', default=2, type=int,
                        help='# of encoder layer in transformer block')
